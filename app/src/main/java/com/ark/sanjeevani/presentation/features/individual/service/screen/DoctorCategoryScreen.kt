...
import com.ark.sanjeevani.presentation.features.individual.service.components.DoctorCategoryCard
...
fun DoctorCategoryScreen(
    ...
    LaunchedEffect(true) {
        viewModel.onEvent(ServiceUiEvent.GetService(ServiceType.DOCTOR))
    }
